    ...
    <footer className="bg-gray-50 border-t border-gray-200 py-10">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-2">
              Helping you find your dream job with ease and speed.
            </p>
            <p className="text-sm text-gray-500 mt-4">© 2024 Job Hunt. All rights reserved.</p>
          </div>
          ...
          {/* Newsletter */}
          <div>
            <h3 className="text-lg font-semibold text-gray-700 mb-2">Subscribe to Newsletter</h3>
            <p className="text-sm text-gray-600 mb-3">Stay updated with latest job alerts</p>
        ...
        <div className="border-t border-gray-200 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
          <p className="mb-4 md:mb-0">Designed with ❤️ by Job Hunt Team</p>
